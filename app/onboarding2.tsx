...
export default function Onboarding2() {
  ...
  const handleNext = () => {
    router.push('/onboarding3' as any);
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        {/* Illustration */}
        <Image
          source={require('@/assets/images/upload-files-img.png')}
        ...
        <Text style={styles.subtitle}>
          Easily upload documents from your phone for quick and convenient printing.
        </Text>
      </View>
