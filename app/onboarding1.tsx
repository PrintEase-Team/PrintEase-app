...
export default function Onboarding1() {
  ...
  const handleNext = () => {
    router.push('/onboarding2' as any);
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        {/* Illustration */}
        <Image
          source={require('@/assets/images/guy-printing-img.png')}
        ...
        <Text style={styles.title}>
          Skip the queue.{'\n'}
          Print with <Text style={styles.highlightText}>ease.</Text>
        </Text>

        {/* Subtitle */}
        <Text style={styles.subtitle}>
          Upload, pay and pick up your prints without waiting.
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    paddingHorizontal: 24,
    marginTop: -height * 0.02, // slightly shift upwards for balance
  },
  illustration: {
    width: width * 0.85,
    height: height * 0.35,
