  ...
  useEffect(() => {
    ...
    const mappedOrders = data.map((o: any) => {
      ...
      if (includeInChart) {
        ...
        if (o.color_mode === 'Black_and_White') bwCount++;
        if (o.color_mode === 'Colored') colorCount++;
        if (o.requires_binding) bindingCount++;
        if (o.document_name && o.document_name.toLowerCase().includes('scan')) scanCount++;
